package vietduchospital.repository;

import vietduchospital.VietduchospitalApp;
import vietduchospital.config.Constants;
import vietduchospital.config.audit.AuditEventConverter;
import vietduchospital.domain.PersistentAuditEvent;
...
import static vietduchospital.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
